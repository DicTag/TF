...
function AssistHaste.OnFrameCreate()
	...
	nX,nY=ui:Append("Text", { txt = "无加速", x = 220, y = 101, }):Click(function()  AssistHaste.SetPreEx(0) end):Size(50,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "1%×5  枕上 梦歌 蚕心 ", x = nX+18, y = 101, }):Click(function()  AssistHaste.SetPreEx(50) end):Size(182,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "2%×3  太极", x = nX+20, y = 101, }):Click(function()  AssistHaste.SetPreEx(60) end):Size(98,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "2%×5  妙镜", x = nX+20, y = 101, }):Click(function()  AssistHaste.SetPreEx(105) end):Size(98,28):Pos_()	
	nX,nY=ui:Append("Text", { txt = "5% 如风 沁心 凝绝 碎冰", x = 220, y = 126, }):Click(function()  AssistHaste.SetPreEx(51) end):Size(190,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "5% 红尘", x = nX+20, y = 126, }):Click(function()  AssistHaste.SetPreEx(52) end):Size(64,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "10% 毒手", x =nX+20, y = 126, }):Click(function()  AssistHaste.SetPreEx(102) end):Size(72,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "20% 聚精凝神", x =nX+20, y = 126, }):Click(function()  AssistHaste.SetPreEx(204) end):Size(110,28):Pos_()	
------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------
	...
	nY=nY+15
	nX, _ =ui:Append("Text", { txt = "红尘月破", x = 380, y = nY, }):Click(function()  AssistHaste.SetPre("MJYP") end):Size(65,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "气纯太极", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("QCTJ") end):Size(65,28):Pos_()	
	nY=nY+15
	nX, _ =ui:Append("Text", { txt = "枕上新妆", x = 380, y =nY, }):Click(function()  AssistHaste.SetPre("BXXZ") end):Size(65,28):Pos_()
	nX, _ =ui:Append("Text", { txt = "枕上玉素", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("BXYS") end):Size(65,28):Pos_()	
	nX, _ =ui:Append("Text", { txt = "奶秀回雪", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("NXHX") end):Size(65,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "奶秀玲珑", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("NXLL") end):Size(65,28):Pos_()	
	nY=nY+15
	nX, _ =ui:Append("Text", { txt = "梦歌阳明",  x = 380, y =nY, }):Click(function()  AssistHaste.SetPre("HJYM") end):Size(65,28):Pos_()	
	nX, _ =ui:Append("Text", { txt = "梦歌快雪",  x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("HJKX") end):Size(65,28):Pos_()
	nX, _ =ui:Append("Text", { txt = "青歌快雪",  x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("QGKX") end):Hover(function() str = "有梦歌"  TF.ShowTip(str,35) end,function() HideTip() end):Size(65,28):Pos_()	
	nX,nY=ui:Append("Text", { txt = "奶花局针",  x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("NHJZ") end):Size(65,28):Pos_()	
	nY=nY+15
	nX, _ =ui:Append("Text", { txt = "奶花长针",  x = 380, y = nY, }):Click(function()  AssistHaste.SetPre("NHCZ") end):Size(65,28):Pos_()
	nX, _ =ui:Append("Text", { txt = "青律长针",  x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("QLCZ") end):Size(65,28):Pos_()
	nX, _ =ui:Append("Text", { txt = "奶花提针",  x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("NHTZ") end):Size(65,28):Pos_()	
	nX,nY=ui:Append("Text", { txt = "竭沢提针",  x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("JZTZ") end):Size(65,28):Pos_()		
	nY=nY+15
	nX, _ =ui:Append("Text", { txt = "奶毒醉舞", x = 380, y = nY, }):Click(function()  AssistHaste.SetPre("NDZW") end):Size(65,28):Pos_()
	nX,nY=ui:Append("Text", { txt = "纳精醉舞", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("NJZW") end):Size(65,28):Pos_()
	nY=nY+15
 	nX, _ =ui:Append("Text", { txt = "唐门暴雨", x = 380, y = nY, }):Click(function()  AssistHaste.SetPre("TMBY") end):Size(65,28):Pos_()
	nX, _ =ui:Append("Text", { txt = "惊羽夺魄", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("JYDP") end):Size(65,28):Pos_()
	nX, nY =ui:Append("Text", { txt ="天罗蚀肌", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("TLJD") end):Size(65,28):Pos_()	
	nY=nY+15
 	nX, _ =ui:Append("Text", { txt = "如风云飞", x = 380, y = nY, }):Click(function()  AssistHaste.SetPre("CJYF") end):Size(65,28):Pos_()
	nX, nY =ui:Append("Text", { txt = "如风夕照", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("CJXZ") end):Size(65,28):Pos_()
	nY=nY+15
 	nX, _ =ui:Append("Text", { txt = "长歌：徵", x = 380, y = nY, }):Click(function()  AssistHaste.SetPre("CGZ") end):Hover(function() str = "有沁心/凝绝"  TF.ShowTip(str,35) end,function() HideTip() end):Size(65,28):Pos_()
	nX, _ =ui:Append("Text", { txt = "争簇：徵", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("ZCZ") end):Hover(function() str = "有沁心/凝绝"  TF.ShowTip(str,35) end,function() HideTip() end):Size(65,28):Pos_()	
 	nX, _ =ui:Append("Text", { txt = "长歌：宫", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("CGG") end):Hover(function() str = "有沁心/凝绝"  TF.ShowTip(str,35) end,function() HideTip() end):Size(65,28):Pos_()
	nX, nY =ui:Append("Text", { txt = "广雅：宫", x = nX+25, y = nY, }):Click(function()  AssistHaste.SetPre("GYG") end):Hover(function() str = "有沁心"  TF.ShowTip(str,35) end,function() HideTip() end):Size(65,28):Pos_()	
end
...
function AssistHaste._OpenWindow()
 ...
 function AssistHaste.CalRes(ExA,dutiao,hip)
	...
	for i=1,grade do
		...
		if TotA<ExA then  NeedB=0  else    NeedB=math.ceil((TotA-ExA)*47.172/10.24) end	--47.16错的	--长歌凝绝51
